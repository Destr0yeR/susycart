...
public class JugadorInput : MonoBehaviour {
	...
	{
		verificar_input();
		if(Input.GetKeyDown(_TRIANGLE) || Input.GetKeyDown(_CROSS) || Input.GetKeyDown(_CIRCLE))
		{
			Debug.Log("triangulando");
		}
	}
	...
	void set_keys_jugador ()
	{
		switch(num_jugador)
		{
			case 1: _TRIANGLE = KeyCode.Joystick1Button3;
					_SQUARE = KeyCode.Joystick1Button2;
					_CIRCLE = KeyCode.Joystick1Button1;
					_CROSS = KeyCode.Joystick1Button0;
					_L1 = KeyCode.Joystick1Button6;
					_R1 = KeyCode.Joystick1Button7;
					break;
			case 2: _TRIANGLE = KeyCode.Joystick2Button3;
					_SQUARE = KeyCode.Joystick2Button2;
					_CIRCLE = KeyCode.Joystick2Button1;
					_CROSS = KeyCode.Joystick2Button0;
					_L1 = KeyCode.Joystick2Button6;
					_R1 = KeyCode.Joystick2Button7;
					break;
			case 3: _TRIANGLE = KeyCode.Joystick3Button3;
					_SQUARE = KeyCode.Joystick3Button2;
					_CIRCLE = KeyCode.Joystick3Button1;
					_CROSS = KeyCode.Joystick3Button0;
					_L1 = KeyCode.Joystick3Button6;
					_R1 = KeyCode.Joystick3Button7;
					break;
			case 4: _TRIANGLE = KeyCode.Joystick4Button3;
					_SQUARE = KeyCode.Joystick4Button2;
					_CIRCLE = KeyCode.Joystick4Button1;
					_CROSS = KeyCode.Joystick4Button0;
